...
GRANT USAGE ON SCHEMA service TO admin, app, readonly;



GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA service TO admin;

GRANT SELECT, INSERT, UPDATE, DELETE
ON ALL TABLES IN SCHEMA service
TO app;
...
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA service TO admin;

GRANT USAGE, SELECT, UPDATE
ON ALL SEQUENCES IN SCHEMA service
TO app;
